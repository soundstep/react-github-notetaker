...
const UserProfile = ({bio}) => {
    return (
        <div>
            ...
            {bio.followers !== undefined && <li className="list-group-item">Followers: {bio.followers}</li>}
            {bio.following !== undefined && <li className="list-group-item">Following: {bio.following}</li>}
